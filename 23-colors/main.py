...
def draw():
    ...
    # fill function with 1 parameter
    # you can use values in the range 0 (black) to 255 (white):
    p5.fill(255) # white fill 

    # stroke function with 1 parameter:
    p5.stroke(0) # black stroke 

    # strokeWeight function with 1 parameter:
    ...
    # noFill function turns off fill:
    p5.noFill()
    ...
    # fill function with 3 parameters (red, green, blue):
    ...
    # fill function with 4 parameters (red, green, blue, transparency):
    ...
    p5.strokeWeight(4) # 4-pixel stroke
