...
def draw():
    p5.background(255)           
    # strokeWeight function takes 1 parameter (weight)
    ...
    # strokeCap function takes 1 parameter (cap)
    # you can use built-in p5 variables ROUND, SQUARE and PROJECT
    # round line caps:
    ...
    # strokeJoin function takes 1 parameter (join)
    # you can use built-in p5 variables MITER (default), ROUND and BEVEL
